...
return [
    ...
    'App' => [
        ...
        'paths' => [
            ...
            'locales' => [RESOURCES . DS . 'locales' . DS],
        ],
    ],
     ...
     * Will append a query string parameter containing the time the file was modified.
     ...
     * - `errorLogger` - Cake\Error\ErrorLoggerInterface - The class responsible for logging errors and unhandled exceptions.
     */
    'Error' => [
        'errorLevel' => E_ALL,
     ...
     *   `Debugger` should replace in dumped data and logs.
     */
    'Debugger' => [
        'editor' => 'phpstorm',
    ],
     ...
     * `defaults` key is used to define a preset to use for session configuration.
     * Any settings declared here will override the settings of the default
     * config.
     *
     * ## Options
     *
     * - `cookie` - The name of the cookie to use. Defaults to value set for
     *   `session.name` php.ini config or 'CAKEPHP'.
